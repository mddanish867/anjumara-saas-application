  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 mt-20">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
        <div className="rounded-2xl border border-[#38bdf8] p-6 shadow-sm ring-1 ring-[#38bdf8] sm:order-last sm:px-8 lg:p-12">
        ...
        <div className="rounded-2xl border p-6 shadow-lg sm:px-8 lg:p-12">
          <div className="text-center">
