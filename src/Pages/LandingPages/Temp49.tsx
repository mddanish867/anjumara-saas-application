            ...
            <div className="flex justify-between">
              {otp.map((digit, index) => (
                <input
                  ...
                  className=" appearance-none border border-orange-300  w-12 h-12 text-center text-white mb-3 leading-tight focus:outline-none focus:shadow-outline bg-black"
                  type="text"
                  maxLength={1}
                  value={digit}
