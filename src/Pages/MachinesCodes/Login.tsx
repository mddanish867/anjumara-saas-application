              ...
              Anjum<span className="text-blue-500">Ara</span>
                ...
                >
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <a href="javascript:void(0)" className="text-center text-blue-500 hover:text-blue-500">Forgot password?</a>
                    </div>
                    <button
                        className="w-full px-4 py-2 text-white font-medium bg-blue-500 hover:bg-blue-500 active:bg-blue-500 rounded-lg duration-150"
                    >
                        Sign in
                    </button>
                </form>
                ...
                <p className="text-center">Don't have an account? <a href="javascript:void(0)" className="font-medium text-blue-500 hover:text-blue-500">Sign up</a></p>
            </div>
        </main>
  )
}
