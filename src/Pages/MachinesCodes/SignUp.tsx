            ...
            <div className="flex-1 flex items-center justify-center h-screen">
              ...
              Anjum<span className="text-blue-500">Ara</span>
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Already have an account? <a href="javascript:void(0)" className="font-medium text-blue-500 hover:text-blue-500">Log in</a></p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <button
                            className="w-full px-4 py-2 text-white font-medium bg-blue-500 hover:bg-blue-500 active:bg-blue-600 rounded-lg duration-150"
                        >
                            Create account
                        </button>
                    </form>
