...
export default function Temp30() {
  const [isMenuOpen, setIsMenuOpen] = useState(false)

  return (
    <div className="md:container min-h-screen bg-indigo-800 text-white">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-gray-800 p-4">
          ...
          <button className="mt-4 w-full bg-white text-black px-4 py-2 rounded-full hover:bg-gray-200">
            JOIN ZYRO
          </button>
        </div>
      )}
      ...
      <main className="container mx-auto px-4 py-12 md:py-24 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <button className="border border-white text-white px-6 py-3 rounded-md text-lg font-semibold ">
            CREATE A FREE WEBSITE
          </button>
        </div>
        <div className="md:w-1/2 grid grid-cols-2 gap-4">
          <img src="/Temp61.png" alt="Website example 1" className="rounded-lg" />
          <img src="/temp29.png" alt="Website example 2" className="rounded-lg" />
          <img src="/temp28.png" alt="Website example 3" className="rounded-lg" />
          <img src="/temp27.png" alt="Website example 4" className="rounded-lg" />
        </div>
      </main>
    </div>
  )
